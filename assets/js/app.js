                ...
                <div class="flex items-center justify-between h-16">
                   <a href="index.html" class="font-black tracking-tight text-xl">
                    ...
                    <nav class="hidden md:flex items-center gap-8">
                        ...
                        <a href="index.html#service" class="hover:text-orange">Service</a>
                        <a href="menu.html" class="hover:text-orange">Menu</a>
                        <a href="menu.html" class="hover:text-orange">Shop</a>
                    </nav>
    ...
    footer.innerHTML = `
        ...
        <div class="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
          <div class="col-span-2">
            <div>
              <h2 class="text-2xl font-bold text-gray-900 dark:text-white"><span class="text-accent">Grill</span>Master</h2>
          ...
          <div class="col-span-2 sm:col-span-1">
            <p class="font-medium text-gray-900 dark:text-white">Shop</p>
      ...
      <div class="mt-8 border-t border-gray-100 pt-8 dark:border-gray-800">
        <div class="sm:flex sm:justify-between">
          <p class="text-xs text-gray-500 dark:text-gray-400">
            &copy; 2025. <span class="text-accent">Grill</span>Master All rights reserved by Rishindu Yohan.
          </p>
